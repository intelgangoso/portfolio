...
const { portfolioQueries, 
        ...
        userQueries,
        forumMutations,
        forumQueries } = require("./resolvers"); //graphQL resolvers
const { portfolioTypes, userTypes, forumTypes } = require("./types"); //graphQL types
...
exports.createApolloServer = () => {
    ...
    //resolver provider for API endpoints
    const resolvers = {
        Query: {
            ...portfolioQueries,
            ...userQueries,
